...
```{r echo=FALSE, fig.cap = "Distribution of Maple trees in a 1,000 x 1,000 ft study area.", fig.width=2, fig.height=2}
...
```{r echo=FALSE, fig.cap = "A highly recommended book for anyone serious about exploring spatial data is O'Sullivan and Unwin's **Geographic Information Analysis** [@Unwin1]. The book tackles general concepts and theory behind spatial analysis.", marginfigure  = TRUE, fig.width=1.5, fig.height=2}

knitr::include_graphics("img/GeographicInformationAnalysis_cover.png")
```
