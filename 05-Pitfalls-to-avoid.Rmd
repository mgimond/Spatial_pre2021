...
```{r f05-kidney3, echo=FALSE, fig.cap = "Population count for each county. Note that a quantile classification scheme is adopted force a large range of values to be assigned a single color swatch", out.width=504}
