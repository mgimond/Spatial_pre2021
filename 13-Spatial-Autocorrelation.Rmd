...
```{r f13-MC-result, echo=FALSE, fig.cap="Results from 199 permutations. Left plot shows Moran's I slopes (in gray) from each random permutation of income values superimposed with the observed Moran's I slope (in red). Right plot shows the distribution of Moran's I values for all 199 permutations; red vertical line shows our observed Moran's I value of 0.377.", out.width=400, fig.align='center'}
...
```{r f13-MC-distance, echo=FALSE, fig.cap="Moran's I at different spatial lags defined by a 50 km width annulus at 50 km distance increments. Red dots indicate Moran I values for which a P-value was 0.05 or less.", out.width=400, fig.align='center'}
...
```{r f13-local-I-MC, echo=FALSE, fig.cap="Significantly High-High and Low-Low clusters with P-values less than or equal to 0.5.", out.height=300, out.width=300, fig.align='center'}
