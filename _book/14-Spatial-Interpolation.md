...
<div class="figure">
<img src="14-Spatial-Interpolation_files/figure-html/unnamed-chunk-2-1.png" alt="Average yearly precipitation (reported in inches) for several meteorological sites in Texas." width="672" />
<p class="caption">(\#fig:unnamed-chunk-2)Average yearly precipitation (reported in inches) for several meteorological sites in Texas.</p>
</div>
...
<div class="figure">
<img src="14-Spatial-Interpolation_files/figure-html/unnamed-chunk-3-1.png" alt="Tessellated surface generated from discrete point samples. This is also known as a *Thiessen interpolation*." width="672" />
<p class="caption">(\#fig:unnamed-chunk-3)Tessellated surface generated from discrete point samples. This is also known as a *Thiessen interpolation*.</p>
</div>
...
<div class="figure">
<img src="14-Spatial-Interpolation_files/figure-html/unnamed-chunk-4-1.png" alt="An IDW interpolation of the average yearly precipitation (reported in inches) for several meteorological sites in Texas. An IDW power coefficient of 2 was used in this example." width="672" />
<p class="caption">(\#fig:unnamed-chunk-4)An IDW interpolation of the average yearly precipitation (reported in inches) for several meteorological sites in Texas. An IDW power coefficient of 2 was used in this example.</p>
</div>
...
<div class="figure">
<img src="14-Spatial-Interpolation_files/figure-html/unnamed-chunk-5-1.png" alt="An IDW interpolation of the average yearly precipitation (reported in inches) for several meteorological sites in Texas. An IDW power coefficient of 15 was used in this example." width="672" />
<p class="caption">(\#fig:unnamed-chunk-5)An IDW interpolation of the average yearly precipitation (reported in inches) for several meteorological sites in Texas. An IDW power coefficient of 15 was used in this example.</p>
</div>
...
<img src="14-Spatial-Interpolation_files/figure-html/unnamed-chunk-6-1.png" width="672" />
...
<div class="figure">
<img src="14-Spatial-Interpolation_files/figure-html/unnamed-chunk-8-1.png" alt="In this example an IDW  power coefficient of 2 was used and the search parameters was confined to a minimum number of points of 10 and a maximum number of points of 15. The search window was isotropic. Each pixel represents the range of precipitation values (in inches) around the expected value given a 95% confidence interval." width="672" />
<p class="caption">(\#fig:unnamed-chunk-8)In this example an IDW  power coefficient of 2 was used and the search parameters was confined to a minimum number of points of 10 and a maximum number of points of 15. The search window was isotropic. Each pixel represents the range of precipitation values (in inches) around the expected value given a 95% confidence interval.</p>
</div>
...
<img src="14-Spatial-Interpolation_files/figure-html/unnamed-chunk-9-1.png" alt="The simplest model where all interpolated surface values are equal to the mean precipitation." width="672" />
<p class="caption">(\#fig:unnamed-chunk-9)The simplest model where all interpolated surface values are equal to the mean precipitation.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="14-Spatial-Interpolation_files/figure-html/unnamed-chunk-10-1.png" alt="Result of a first order interpolation." width="672" />
<p class="caption">(\#fig:unnamed-chunk-10)Result of a first order interpolation.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="14-Spatial-Interpolation_files/figure-html/unnamed-chunk-11-1.png" alt="Result of a second order interpolation" width="672" />
<p class="caption">(\#fig:unnamed-chunk-11)Result of a second order interpolation</p>
</div>
...
<div class="figure">
<img src="14-Spatial-Interpolation_files/figure-html/unnamed-chunk-13-1.png" alt="Map showing de-trended precipitation values (aka residuals). These detrended values are then passed to the ordinary kriging interpolation operations. You can think of these residuals as representing variability in the data not explained by the global trend. If variability is present in the residuals then it is best characterized as a distance based measure of variability (as opposed to a location based measure)." width="672" />
<p class="caption">(\#fig:unnamed-chunk-13)Map showing de-trended precipitation values (aka residuals). These detrended values are then passed to the ordinary kriging interpolation operations. You can think of these residuals as representing variability in the data not explained by the global trend. If variability is present in the residuals then it is best characterized as a distance based measure of variability (as opposed to a location based measure).</p>
</div>
...
<div class="figure">
<img src="14-Spatial-Interpolation_files/figure-html/unnamed-chunk-14-1.png" alt="Locations of two sample sites used to demonstrate the the calculation of *gamma*." width="672" />
<p class="caption">(\#fig:unnamed-chunk-14)Locations of two sample sites used to demonstrate the the calculation of *gamma*.</p>
</div>
...
<img src="14-Spatial-Interpolation_files/figure-html/unnamed-chunk-15-1.png" width="672" />

The red point in the plot is  the value computed in the above example. The distance separating those two points is about  km. This value is mapped in the above plots as a red dot.
...
<img src="14-Spatial-Interpolation_files/figure-html/unnamed-chunk-16-1.png" width="672" />
...
<img src="14-Spatial-Interpolation_files/figure-html/unnamed-chunk-17-1.png" width="672" />
...
<img src="14-Spatial-Interpolation_files/figure-html/unnamed-chunk-18-1.png" width="672" />
...
<img src="14-Spatial-Interpolation_files/figure-html/unnamed-chunk-19-1.png" width="672" />
...
<div class="figure" style="text-align: center">
<img src="14-Spatial-Interpolation_files/figure-html/unnamed-chunk-20-1.png" alt="Krige interpolation of the residual (detrended) precipitation values." width="672" />
<p class="caption">(\#fig:unnamed-chunk-20)Krige interpolation of the residual (detrended) precipitation values.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="14-Spatial-Interpolation_files/figure-html/unnamed-chunk-21-1.png" alt="The final kriged surface." width="672" />
<p class="caption">(\#fig:unnamed-chunk-21)The final kriged surface.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="14-Spatial-Interpolation_files/figure-html/unnamed-chunk-22-1.png" alt="Variance map resulting from the Kriging analysis." width="672" />
<p class="caption">(\#fig:unnamed-chunk-22)Variance map resulting from the Kriging analysis.</p>
</div>
