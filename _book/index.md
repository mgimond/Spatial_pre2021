...
The Appendix covers various aspects of spatial data manipulation and analysis using R. The course only focuses on point pattern analysis and spatial autocorelation using R, but I've added other R resources for students wishing to expand there GIS skills into R.
